	...
	return (
		<section id="quytrinh" className="py-20 bg-solemate-light">
			<div className="container">
				<h2 className="section-heading">Các giai đoạn trong giải pháp</h2>
				<p className="section-desc">
					Để có thể trải nghiệm giải pháp của chúng tôi thì các bạn sẽ được tư vấn kĩ càng qua ba bước.
				</p>
